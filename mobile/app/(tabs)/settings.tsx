  ...
  return (
    ...
    >
      ...
      >
        ...
        <SectionHeader
          title="Appearance"
          icon={<Palette size={15} color={theme.colors.muted} />}
        />
        ...
        <SectionHeader
          title="Audio"
          icon={<Volume2 size={15} color={theme.colors.muted} />}
        />
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <View
            style={[
          ...
          >
            ...
            <Text
              style={[styles.rowLabel, { color: theme.colors.text, flex: 1 }]}
            >
              Mute All Sounds
            </Text>
            <Switch
        ...
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          ...
          <TouchableOpacity
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={[
                  styles.rowSub,
                  {
                    color: usdtType ? theme.colors.primary : theme.colors.muted,
                  },
                ]}
              >
            ...
            <ChevronRight
              ...
              style={{
                transform: [{ rotate: networkOpen ? '90deg' : '0deg' }],
              }}
            />
          </TouchableOpacity>
          ...
          {user?.usdtAddress && (
            <Text style={[styles.walletHint, { color: theme.colors.muted }]}>
              ⚠️ Double-check your address — payouts to wrong addresses cannot
              be recovered.
            </Text>
          )}
        </View>
        ...
        <SectionHeader
          title="Privacy"
          icon={<Shield size={15} color={theme.colors.muted} />}
        />
        <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
          <View style={styles.cardRow}>
            <View style={{ flex: 1 }}>
              <Text style={[styles.rowLabel, { color: theme.colors.text }]}>
                Show me as - Ready to Play
              </Text>
              <Text style={[styles.rowSub, { color: theme.colors.muted }]}>
                Let others see your username in the home screen carousel and
            ...
            <Switch
              ...
              onValueChange={async (val) => {
                ...
                try {
                  ...
                  setUser({
                    ...user!,
                    publicProfile: res.data.settings.publicProfile,
                  });
                  showToast(
                    val
                      ? "You're now visible to other players"
                      : "You're now hidden from the carousel",
                  );
                } catch {
              ...
              thumbColor={
                publicProfile ? theme.colors.primary : theme.colors.muted
              }
              trackColor={{
                false: theme.colors.border,
                true: theme.colors.primary + '66',
